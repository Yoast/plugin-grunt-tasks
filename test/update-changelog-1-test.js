...
const tempFilePath = [ "tmp/readme.txt" ];
const expectedFilePath = [ "test/expected/readme.txt" ];
const srcWikimdfile = "test/fixtures/wordpress-seo-16.0.md"
const dstWikimdfile = "./.tmp/wordpress-seo-16.0.md"
const noOfFiles = Math.min( tempFilePath.length, expectedFilePath.length );
let ChanceLogTask;

exports.testChangeLog1Command = {
	/**
